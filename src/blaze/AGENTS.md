...
- **Lifecycle state machine**: The persisted model contains 13 states. Current
  managed routes implement create, destroy, checkpoint capture/list/prune,
  rollback, hibernate, resume, and
